...
include 'Model/Searchby.php';
include 'Model/Home.php';

 
 $search_network_obj= new Searchby();

 if (isset($_GET['search_val'])){
 $thereeg_data = $search_network_obj->get_searched_results($_GET['search_val']);
 }
 if(isset($_GET['id'])){

 

  $thereeg_data = $search_network_obj->branded_search($_GET['id']);

 }
$home_obj = new Home();
 $cat_ino_obj=new Singale();
 $Que=$home_obj->brand_Q();
 $cat_info=$cat_ino_obj->get_categories();
...
<div class="left_area" id="left_panel">
  ...
  <?php
                           ...
                           $no_of_items = $cat_ino_obj->get_category_products($cat_data['id']);
  	...
  	<div class="cell_phones">
        ...
        <div class="list_cellphone">
        	<ul>
             ...
             <?php foreach ($thereeg_data as $all_threeg_mob) {?>
               
            
            	<li>
                <p class="box-mobile">
                <a href="single.php?id=<?php echo $all_threeg_mob['product_id'];   ?>" title="HTC Desire 620"><img src="/mobile/public/assets/products/<?php echo  $all_threeg_mob['img'];?>" title="HTC Desire 620" alt="HTC Desire 620" border="0" height="100" /></a>
                </p>
                <p class="mob_title2"><a href="single.php?id=<?php echo $all_threeg_mob['id'];   ?>" title="HTC Desire 620"><?php echo $all_threeg_mob['name'];  ?></a></p>
                <span class="price">SAR 1,369.00</span>
                <p class="mob_detail"><?php echo $all_threeg_mob['description'];   ?></p>
                <span class="view_detail"><a href="single.php?id=<?php echo $all_threeg_mob['id'];   ?>">View Detail</a></span>
            </li>
